...
// Pages
const Dashboard = React.lazy(() => import('@domains/dashboard/pages/Dashboard'));
...
const ThemeCreate = React.lazy(() => import('@domains/themes/pages/ThemeCreate'));
const ThemeDetail = React.lazy(() => import('@domains/themes/pages/ThemeDetail'));
